            ...
            <tbody className="divide-y divide-gray-200">
              {drivers.map((driver) => (
                <tr key={driver.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 text-sm text-gray-900">{driver.user?.name || driver.name || 'Unknown'}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{driver.user?.email || driver.email || '-'}</td>

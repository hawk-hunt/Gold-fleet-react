            ...
            <tbody className="divide-y divide-gray-200">
              {trips.map((trip) => (
                <tr key={trip.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{trip.driver?.user?.name || trip.driver?.name || '-'}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{trip.vehicle?.license_plate || trip.vehicle?.make} {trip.vehicle?.model || '-'}</td>
